...
void vkDisplayXcb::resize_window(const unsigned int width, const unsigned int height, VkSurfaceTransformFlagBitsKHR rot, const VkSurfaceCapabilitiesKHR& surf_caps) {
