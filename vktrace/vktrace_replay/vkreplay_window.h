...
class ReplayDisplayImp {
   public:
    ...
    virtual void resize_window(const unsigned int width, const unsigned int height, VkSurfaceTransformFlagBitsKHR rot, const VkSurfaceCapabilitiesKHR& surf_caps) = 0;
