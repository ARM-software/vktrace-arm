...
vktraceviewer_QGenerateTraceDialog::vktraceviewer_QGenerateTraceDialog(QWidget *parent)
    ...
    m_pApplicationLabel->setText(QApplication::translate("vktraceviewer_QGenerateTraceDialog",
                                                         "<span style=\"color: red;\">*</span>Application to trace:", 0));
    ...
    m_pVkLayerPathLabel->setText(
        QApplication::translate("vktraceviewer_QGenerateTraceDialog", "<span style=\"color: red;\">*</span>VK_LAYER_PATH:", 0));
    ...
    m_pTracefileLabel->setText(
        QApplication::translate("vktraceviewer_QGenerateTraceDialog", "<span style=\"color: red;\">*</span>Output trace file:", 0));
...
QString vktraceviewer_QGenerateTraceDialog::get_trace_file_path() { return m_pTraceFileLineEdit->text(); }

void vktraceviewer_QGenerateTraceDialog::on_applicationLineEdit_textChanged(const QString &text) { check_inputs(); }

void vktraceviewer_QGenerateTraceDialog::on_vkLayerPathLineEdit_textChanged(const QString &text) { check_inputs(); }

void vktraceviewer_QGenerateTraceDialog::on_traceFileLineEdit_textChanged(const QString &text) { check_inputs(); }
...
void vktraceviewer_QGenerateTraceDialog::on_findTraceFileButton_clicked() {
    ...
    QString selectedName =
        QFileDialog::getSaveFileName(this, tr("Output Trace File"), suggestedName, tr("vktrace file (*.vktrace *.*)"));
    if (!selectedName.isEmpty()) {
