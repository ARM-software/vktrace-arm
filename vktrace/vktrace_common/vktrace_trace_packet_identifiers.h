...
typedef enum _VKTRACE_TRACE_PACKET_ID_VK {
    ...
    //****************Ray tracing extension function begin**********
    VKTRACE_TPI_VK_vkGetDescriptorSetLayoutSupportKHR = 313,
    VKTRACE_TPI_VK_vkGetBufferDeviceAddressKHR = 314,
    VKTRACE_TPI_VK_vkGetBufferOpaqueCaptureAddressKHR = 315,
    VKTRACE_TPI_VK_vkGetDeviceMemoryOpaqueCaptureAddressKHR = 316,
    VKTRACE_TPI_VK_vkCreateDeferredOperationKHR = 317,
    VKTRACE_TPI_VK_vkDestroyDeferredOperationKHR = 318,
    VKTRACE_TPI_VK_vkGetDeferredOperationMaxConcurrencyKHR = 319,
    VKTRACE_TPI_VK_vkGetDeferredOperationResultKHR = 320,
    VKTRACE_TPI_VK_vkDeferredOperationJoinKHR = 321,
    VKTRACE_TPI_VK_vkCreateAccelerationStructureKHR = 322,
    VKTRACE_TPI_VK_vkDestroyAccelerationStructureKHR = 323,
    VKTRACE_TPI_VK_vkCmdBuildAccelerationStructuresKHR = 324,
    VKTRACE_TPI_VK_vkCmdBuildAccelerationStructuresIndirectKHR = 325,
    VKTRACE_TPI_VK_vkBuildAccelerationStructuresKHR = 326,
    VKTRACE_TPI_VK_vkCopyAccelerationStructureKHR = 327,
    VKTRACE_TPI_VK_vkCopyAccelerationStructureToMemoryKHR = 328,
    VKTRACE_TPI_VK_vkCopyMemoryToAccelerationStructureKHR = 329,
    VKTRACE_TPI_VK_vkWriteAccelerationStructuresPropertiesKHR = 330,
    VKTRACE_TPI_VK_vkCmdCopyAccelerationStructureKHR = 331,
    VKTRACE_TPI_VK_vkCmdCopyAccelerationStructureToMemoryKHR = 332,
    VKTRACE_TPI_VK_vkCmdCopyMemoryToAccelerationStructureKHR = 333,
    VKTRACE_TPI_VK_vkGetAccelerationStructureDeviceAddressKHR = 334,
    VKTRACE_TPI_VK_vkCmdWriteAccelerationStructuresPropertiesKHR = 335,
    VKTRACE_TPI_VK_vkGetDeviceAccelerationStructureCompatibilityKHR = 336,
    VKTRACE_TPI_VK_vkGetAccelerationStructureBuildSizesKHR = 337,
    VKTRACE_TPI_VK_vkCmdSetRayTracingPipelineStackSizeKHR = 338,
    VKTRACE_TPI_VK_vkCmdTraceRaysIndirectKHR = 339,
    VKTRACE_TPI_VK_vkCmdTraceRaysKHR = 340,
    VKTRACE_TPI_VK_vkCreateRayTracingPipelinesKHR = 341,
    VKTRACE_TPI_VK_vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = 342,
    VKTRACE_TPI_VK_vkGetRayTracingShaderGroupHandlesKHR = 343,
    VKTRACE_TPI_VK_vkGetRayTracingShaderGroupStackSizeKHR = 344,
    VKTRACE_TPI_VK_vkCmdSetFragmentShadingRateKHR = 345,
    VKTRACE_TPI_VK_vkGetPhysicalDeviceFragmentShadingRatesKHR = 346,
    //****************Ray tracing extension function end**************
    VKTRACE_TPI_VK_vkCreateHeadlessSurfaceEXT = 347,
    VKTRACE_TPI_VK_vkCmdBindShadingRateImageNV = 348,
    VKTRACE_TPI_VK_vkCmdSetViewportShadingRatePaletteNV = 349,
    VKTRACE_TPI_VK_vkCmdSetCoarseSampleOrderNV = 350,
    VKTRACE_TPI_VK_vkCreateAccelerationStructureNV = 351,
    VKTRACE_TPI_VK_vkDestroyAccelerationStructureNV = 352,
    VKTRACE_TPI_VK_vkGetAccelerationStructureMemoryRequirementsNV = 353,
    VKTRACE_TPI_VK_vkBindAccelerationStructureMemoryNV = 354,
    VKTRACE_TPI_VK_vkCmdBuildAccelerationStructureNV = 355,
    VKTRACE_TPI_VK_vkCmdCopyAccelerationStructureNV = 356,
    VKTRACE_TPI_VK_vkCmdTraceRaysNV = 357,
    VKTRACE_TPI_VK_vkCreateRayTracingPipelinesNV = 358,
    VKTRACE_TPI_VK_vkGetRayTracingShaderGroupHandlesNV = 359,
    VKTRACE_TPI_VK_vkGetAccelerationStructureHandleNV = 360,
    VKTRACE_TPI_VK_vkCmdWriteAccelerationStructuresPropertiesNV = 361,
    VKTRACE_TPI_VK_vkCompileDeferredNV = 362,
    VKTRACE_TPI_VK_vkCmdDrawMeshTasksNV = 363,
    VKTRACE_TPI_VK_vkCmdDrawMeshTasksIndirectNV = 364,
    VKTRACE_TPI_VK_vkCmdDrawMeshTasksIndirectCountNV = 365,
    VKTRACE_TPI_VK_vkCmdSetExclusiveScissorNV = 366,
    VKTRACE_TPI_VK_vkCmdSetCheckpointNV = 367,
    VKTRACE_TPI_VK_vkGetQueueCheckpointDataNV = 368,
    VKTRACE_TPI_VK_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = 369,
    VKTRACE_TPI_VK_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV = 370,
    VKTRACE_TPI_VK_vkGetImageViewHandleNVX = 371,
    VKTRACE_TPI_VK_vkGetImageViewAddressNVX = 372,
    VKTRACE_TPI_VK_vkGetBufferDeviceAddressEXT = 373,
    VKTRACE_TPI_VK_vkCmdBeginDebugUtilsLabelEXT = 374,
    VKTRACE_TPI_VK_vkCmdEndDebugUtilsLabelEXT = 375,
    VKTRACE_TPI_VK_vkCmdInsertDebugUtilsLabelEXT = 376,
    VKTRACE_TPI_VK_vkCreateDebugUtilsMessengerEXT = 377,
    VKTRACE_TPI_VK_vkDestroyDebugUtilsMessengerEXT = 378,
    VKTRACE_TPI_VK_vkQueueBeginDebugUtilsLabelEXT = 379,
    VKTRACE_TPI_VK_vkQueueEndDebugUtilsLabelEXT = 380,
    VKTRACE_TPI_VK_vkQueueInsertDebugUtilsLabelEXT = 381,
    ...
    VKTRACE_TPI_VK_vkDestroyPrivateDataSlot = 387,
    VKTRACE_TPI_VK_vkSetPrivateData = 388,
    VKTRACE_TPI_VK_vkGetPrivateData = 389,
    VKTRACE_TPI_VK_vkCmdSetEvent2 = 390,
    VKTRACE_TPI_VK_vkCmdResetEvent2 = 391,
    VKTRACE_TPI_VK_vkCmdWaitEvents2 = 392,
    VKTRACE_TPI_VK_vkCmdPipelineBarrier2 = 393,
    VKTRACE_TPI_VK_vkCmdWriteTimestamp2 = 394,
    VKTRACE_TPI_VK_vkQueueSubmit2 = 395,
    VKTRACE_TPI_VK_vkCmdCopyBuffer2 = 396,
    VKTRACE_TPI_VK_vkCmdCopyImage2 = 397,
    VKTRACE_TPI_VK_vkCmdCopyBufferToImage2 = 398,
    VKTRACE_TPI_VK_vkCmdCopyImageToBuffer2 = 399,
    VKTRACE_TPI_VK_vkCmdBlitImage2 = 400,
    VKTRACE_TPI_VK_vkCmdResolveImage2 = 401,
    VKTRACE_TPI_VK_vkCmdBeginRendering = 402,
    VKTRACE_TPI_VK_vkCmdEndRendering = 403,
    VKTRACE_TPI_VK_vkCmdSetCullMode = 404,
    VKTRACE_TPI_VK_vkCmdSetFrontFace = 405,
    VKTRACE_TPI_VK_vkCmdSetPrimitiveTopology = 406,
    VKTRACE_TPI_VK_vkCmdSetViewportWithCount = 407,
    VKTRACE_TPI_VK_vkCmdSetScissorWithCount = 408,
    VKTRACE_TPI_VK_vkCmdBindVertexBuffers2 = 409,
    VKTRACE_TPI_VK_vkCmdSetDepthTestEnable = 410,
    VKTRACE_TPI_VK_vkCmdSetDepthWriteEnable = 411,
    VKTRACE_TPI_VK_vkCmdSetDepthCompareOp = 412,
    VKTRACE_TPI_VK_vkCmdSetDepthBoundsTestEnable = 413,
    VKTRACE_TPI_VK_vkCmdSetStencilTestEnable = 414,
    VKTRACE_TPI_VK_vkCmdSetStencilOp = 415,
    VKTRACE_TPI_VK_vkCmdSetRasterizerDiscardEnable = 416,
    VKTRACE_TPI_VK_vkCmdSetDepthBiasEnable = 417,
    VKTRACE_TPI_VK_vkCmdSetPrimitiveRestartEnable = 418,
    VKTRACE_TPI_VK_vkGetDeviceBufferMemoryRequirements = 419,
    VKTRACE_TPI_VK_vkGetDeviceImageMemoryRequirements = 420,
    VKTRACE_TPI_VK_vkGetDeviceImageSparseMemoryRequirements = 421,
    VKTRACE_TPI_VK_vkCreatePrivateDataSlotEXT = 422,
    VKTRACE_TPI_VK_vkDestroyPrivateDataSlotEXT = 423,
    VKTRACE_TPI_VK_vkSetPrivateDataEXT = 424,
