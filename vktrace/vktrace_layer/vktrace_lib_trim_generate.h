...
vktrace_trace_packet_header *vkFlushMappedMemoryRanges(bool makeCall, VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges, void** ppData, VkDeviceSize* pDataSize);
