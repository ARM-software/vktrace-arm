...
if VK_ANDROID_frame_boundary:
    approved_ext.append('VK_ANDROID_frame_boundary')
...
api_remap = [
                ...
                'FlushMappedMemoryRangesRemap',
                'FlushMappedMemoryRangesRemapAsInstanceSGHandle',
                'UnmapMemoryRemapAsInstanceSGHandle',
            ]
...
class VkTraceFileOutputGenerator(OutputGenerator):
    ...
    def genCmd(self, cmdinfo, cmdname, alias):
        ...
        elif cmdname in ['vkCmdPushConstants']:
        ...
        elif cmdname in ['vkFlushMappedMemoryRanges']:
            for postfix in ['', 'AsInstanceSGHandle']:
                self.cmdMembers.append(self.CmdMemberData(name=cmdname+'Remap'+postfix, members=membersInfo))
                self.cmd_info_data.append(self.CmdInfoData(name=cmdname+'Remap'+postfix, cmdinfo=cmdinfo))
                self.cmd_extension_names.append(self.cmd_extension_data(name=cmdname+'Remap'+postfix, extension_name=self.current_feature_name))
                self.cmd_feature_protect.append(self.CmdExtraProtect(name=cmdname+'Remap'+postfix, extra_protect=self.featureExtraProtect))
        elif cmdname in ['vkUnmapMemory']:
            for postfix in ['AsInstanceSGHandle']:
                self.cmdMembers.append(self.CmdMemberData(name=cmdname+'Remap'+postfix, members=membersInfo))
                self.cmd_info_data.append(self.CmdInfoData(name=cmdname+'Remap'+postfix, cmdinfo=cmdinfo))
                self.cmd_extension_names.append(self.cmd_extension_data(name=cmdname+'Remap'+postfix, extension_name=self.current_feature_name))
    ...
    def GenerateReplayGenSource(self):
        ...
        do_while_dict = {'GetFenceStatus': 'replayResult != pPacket->result && pPacket->result == VK_SUCCESS',
                         'GetEventStatus': '(pPacket->result == VK_EVENT_SET && replayResult == VK_EVENT_RESET) || (pPacket->result == VK_EVENT_RESET && replayResult == VK_EVENT_SET)',
                         'GetSemaphoreCounterValue': '*pPacket->pValue < completedValue && pPacket->result == VK_SUCCESS',
                         'GetSemaphoreCounterValueKHR': '*pPacket->pValue < completedValue && pPacket->result == VK_SUCCESS',
        ...
        if VK_ANDROID_frame_boundary:
            replay_gen_source += '#if VK_ANDROID_frame_boundary\n'
            replay_gen_source += '        case VKTRACE_TPI_VK_vkFrameBoundaryANDROID: {\n'
            replay_gen_source += '            packet_vkFrameBoundaryANDROID* pPacket = (packet_vkFrameBoundaryANDROID*)(packet->pBody);\n'
            replay_gen_source += '            replayResult = manually_replay_vkFrameBoundaryANDROID(pPacket);\n'
            replay_gen_source += '            break;\n'
            replay_gen_source += '        }\n'
        ...
        for api in self.cmdMembers:
            ...
            if cmdname in manually_replay_funcs:
                ...
                if create_view:
                    ...
                    replay_gen_source += '                    return vktrace_replay::VKTRACE_REPLAY_ERROR;\n'
                    replay_gen_source += '                }\n'
                    replay_gen_source += '                if (g_pReplaySettings->forceSyncImgIdx && acquireFenceToFSIIFence.find(fences[i]) != acquireFenceToFSIIFence.end()) {\n'
                    replay_gen_source += '                    VkFence acquireFence = fences[i];\n'
                    replay_gen_source += '                    fences[i] = acquireFenceToFSIIFence[fences[i]];\n'
                    replay_gen_source += '                    acquireFenceToFSIIFence.erase(acquireFence);\n'
                    replay_gen_source += '                }\n'
                    replay_gen_source += '            }\n'
                ...
                if cmdname in do_while_dict:
                    if cmdname == 'GetFenceStatus':
                        replay_gen_source += '            if (g_pReplaySettings->forceSyncImgIdx && acquireFenceToFSIIFence.find(remappedfence) != acquireFenceToFSIIFence.end()) {\n'
                        replay_gen_source += '                remappedfence = acquireFenceToFSIIFence[remappedfence];\n'
                        replay_gen_source += '            }\n'
                    ...
                    elif cmdname == 'GetSemaphoreCounterValue':
                        replay_gen_source += '            uint32_t call_id = m_inFrameRange ? VKTRACE_TPI_VK_vkGetSemaphoreCounterValue : 0;\n'
                        replay_gen_source += '            uint64_t completedValue = *pPacket->pValue;\n'
                    elif cmdname == 'GetSemaphoreCounterValueKHR':
                        replay_gen_source += '            uint32_t call_id = m_inFrameRange ? VKTRACE_TPI_VK_vkGetSemaphoreCounterValueKHR : 0;\n'
                        replay_gen_source += '            uint64_t completedValue = *pPacket->pValue;\n'
                ...
                # TODO: need a better way to indicate which extensions should be mapped to which Get*ProcAddr
                    ...
                    for command in self.cmdMembers:
                        ...
                        if 'VK_VERSION_' not in cmd_extension_dict[command.name] and command.name not in api_exclusions:
                            ...
                            if 'DebugUtilsMess' in command_name_novk:
                                # The function address of DebugUtils apis may be NULL, so restore it to the initial value if get NULL pointer.
                                replay_gen_source += '               PFN_%s tmp%s = m_vkFuncs.%s;\n' % (command.name, command_name_novk, command_name_novk)
                            replay_gen_source += '               m_vkFuncs.%s = (PFN_%s)vk%s(remappedinstance, pPacket->pName);\n' % (command_name_novk, command.name, cmdname)
                            if 'DebugUtilsMess' in command_name_novk:
                                replay_gen_source += '               if (m_vkFuncs.%s == NULL)\n' % (command_name_novk)
                                replay_gen_source += '                  m_vkFuncs.%s = tmp%s;\n' % (command_name_novk, command_name_novk)
                            replay_gen_source += '            }\n'
                            if gipa_protect is not None:
                                replay_gen_source += '#endif // %s\n' % gipa_protect
                    ...
                    replay_gen_source += '            if (replaySettings.useEXTFrameBoundary) {\n'
                    replay_gen_source += '                auto it = frameboundarySemaphores.find(pPacket->semaphore); \n'
                    replay_gen_source += '                if (it != frameboundarySemaphores.end()) {\n'
                    replay_gen_source += '                    frameboundarySemaphores.erase(it);\n'
                    replay_gen_source += '                }\n'
                    replay_gen_source += '            }\n'
                    ...
                    replay_gen_source += '            if (g_pReplaySettings->fDevBuild2HostBuild == TRUE) {\n'
                    replay_gen_source += '                traceDeviceAddrTotraceBuffer4Buf[pPacket->result] = pPacket->pInfo->buffer;\n'
                    replay_gen_source += '            }\n'
                    ...
                    replay_gen_source += '                g_devBuild2HostBuild_state = DEVBUILD_TO_HOSTBUILD_DONE;\n'
                    replay_gen_source += '            }\n'
                ...
                if 'DestroyDevice' in cmdname:
                    ...
                    if 'GetBufferDeviceAddress' == cmdname:
                        replay_gen_source += '#if defined(ANDROID)\n'
                        replay_gen_source += '                replayDeviceAddr = m_vkDeviceFuncs.GetBufferDeviceAddressKHR(remappeddevice, pPacket->pInfo);\n'
                        replay_gen_source += '#endif\n'
                    else:
                    ...
                    replay_gen_source += '            }\n'
                elif 'CmdCopyBuffer2' in cmdname:
                    replay_gen_source += '            for (uint32_t i = 0; i < pPacket->pCopyBufferInfo->regionCount; i++) {\n'
                    replay_gen_source += '                remapInstanceBufferDeviceAddressInCopyBuffer(pPacket->pCopyBufferInfo->srcBuffer, pPacket->pCopyBufferInfo->dstBuffer, pPacket->pCopyBufferInfo->pRegions[i].srcOffset, pPacket->pCopyBufferInfo->pRegions[i].size);\n'
                    replay_gen_source += '            }\n'
                elif 'GetAccelerationStructureDeviceAddress' in cmdname:
                    replay_gen_source += '            if (replayDeviceAddr == 0) {\n'
                    ...
                    replay_gen_source += '            m_objMapper.rm_from_instances_map(pPacket->instance);\n'
        ...
        replay_gen_source += '            break;\n'
        replay_gen_source += '        }\n'
        replay_gen_source += '        case VKTRACE_TPI_VK_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle: {\n'
        replay_gen_source += '            packet_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle* pPacket = (packet_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle*)(packet->pBody);\n'
        replay_gen_source += '            manually_replay_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle(pPacket);\n'
        replay_gen_source += '            break;\n'
        replay_gen_source += '        }\n'
        replay_gen_source += '        case VKTRACE_TPI_VK_vkUnmapMemoryRemapAsInstanceSGHandle: {\n'
        replay_gen_source += '            packet_vkUnmapMemoryRemapAsInstanceSGHandle* pPacket = (packet_vkUnmapMemoryRemapAsInstanceSGHandle*)(packet->pBody);\n'
        replay_gen_source += '            manually_replay_vkUnmapMemoryRemapAsInstanceSGHandle(pPacket);\n'
        replay_gen_source += '            break;\n'
        replay_gen_source += '        }\n'
        ...
        replay_gen_source += '            break;\n'
        replay_gen_source += '    }\n'
        replay_gen_source += '    if (replayResult < 0) {\n'
        replay_gen_source += '        vktrace_LogError("gid = %llu, API %s return result = %d", packet->global_packet_index, vktrace_vk_packet_id_name((VKTRACE_TRACE_PACKET_ID_VK)packet->packet_id), replayResult);\n'
        replay_gen_source += '    }\n'
            ...
            if obj == cleanParamType and param.name not in param_exclude_list:
                ...
                if param.ispointer:
                    if param.isconst == False:
                        ...
                        result += '            }\n'
                        return result
                if ((funcName == 'CmdResolveImage') or (funcName == 'CmdCopyImage') or (funcName == 'CmdBlitImage')) and (param.name == 'dstImage'):
                    result = '            SwapchainImageState& curSwapchainImgStat = swapchainImageStates[curSwapchainHandle];\n'
                    result += '            VkImage swapChainImage = pPacket->dstImage;\n'
                    result += '            if (curSwapchainImgStat.traceImageToImageIndex.find(pPacket->dstImage) != curSwapchainImgStat.traceImageToImageIndex.end()\n'
                    result += '                && curSwapchainImgStat.traceImageIndexToImage.find(m_imageIndex) != curSwapchainImgStat.traceImageIndexToImage.end()\n'
                    result += '                && m_imageIndex != UINT32_MAX && !g_pReplaySettings->enableVirtualSwapchain) {\n'
                    result += '                swapChainImage = curSwapchainImgStat.traceImageIndexToImage[m_imageIndex];\n'
                    result += '            }\n'
                    result += '            VkImage remappeddstImage = m_objMapper.remap_images(swapChainImage);\n'
                else:
    ...
    def GenerateTracePacketIdHeader(self):
        ...
        for api in self.cmdMembers:
            ...
            trace_pkt_id_hdr += '        };\n'
        if VK_ANDROID_frame_boundary:
            trace_pkt_id_hdr += '#if VK_ANDROID_frame_boundary\n'
            trace_pkt_id_hdr += '        case VKTRACE_TPI_VK_vkFrameBoundaryANDROID: {\n'
            trace_pkt_id_hdr += '            return "vkFrameBoundaryANDROID";\n'
            trace_pkt_id_hdr += '        }\n'
            trace_pkt_id_hdr += '#endif\n'
    ...
    def GenerateInterpFunc(self):
        ...
        interp_func_body += '        case VKTRACE_TPI_VK_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle: {\n'
        interp_func_body += '            return interpret_body_as_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle(pHeader)->header;\n        }\n'
        interp_func_body += '        case VKTRACE_TPI_VK_vkUnmapMemoryRemapAsInstanceSGHandle: {\n'
        interp_func_body += '            return interpret_body_as_vkUnmapMemoryRemapAsInstanceSGHandle(pHeader)->header;\n        }\n'
        ...
        if VK_ANDROID_frame_boundary:
            interp_func_body += '#if VK_ANDROID_frame_boundary\n'
            interp_func_body += '        case VKTRACE_TPI_VK_vkFrameBoundaryANDROID: {\n'
            interp_func_body += '            return interpret_body_as_vkFrameBoundaryANDROID(pHeader)->header;\n        }\n'
            interp_func_body += '#endif\n'
    ...
    def GenerateThinPacketFunc(self):
        ...
        thinpacket_func_body += '         break;\n'
        thinpacket_func_body += '    }\n'
        thinpacket_func_body += '    case VKTRACE_TPI_VK_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle: {\n'
        thinpacket_func_body += '         generateThinPacket(sizeof(packet_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle) + sizeof(VkMappedMemoryRange), pFatHeader, pHeader, total_packet_size);\n'
        thinpacket_func_body += '         SETVAULE(packet_vkFlushMappedMemoryRangesRemapAsInstanceSGHandle, sizeof(VkMappedMemoryRange), VkMappedMemoryRange, pMemoryRanges)\n'
        thinpacket_func_body += '         break;\n'
        thinpacket_func_body += '    }\n'
        thinpacket_func_body += '    case VKTRACE_TPI_VK_vkUnmapMemoryRemapAsInstanceSGHandle: {\n'
        thinpacket_func_body += '         generateThinPacket(sizeof(packet_vkUnmapMemoryRemapAsInstanceSGHandle), pFatHeader, pHeader, total_packet_size);\n'
        thinpacket_func_body += '         break;\n'
        thinpacket_func_body += '    }\n'
    ...
    def GetPacketPtrParamList(self, params):
        ...
        custom_ptr_dict = {'VkDeviceCreateInfo': {'add_txt': 'add_VkDeviceCreateInfo_to_packet(pHeader, (VkDeviceCreateInfo**) &(pPacket->pCreateInfo), pCreateInfo)',
                           ...
                           'VkDebugUtilsLabelEXT': {'add_txt': 'add_VkDebugUtilsLabelEXT_to_packet(pHeader, (VkDebugUtilsLabelEXT**)&(pPacket->pLabelInfo), pLabelInfo)',
                                                 'finalize_txt': ''},
                           'VkDebugUtilsObjectNameInfoEXT': {'add_txt': 'add_VkDebugUtilsObjectNameInfoEXT_to_packet(pHeader, (VkDebugUtilsObjectNameInfoEXT**)&(pPacket->pNameInfo), pNameInfo)',
                                                 'finalize_txt': ''},
                           'VkDebugUtilsObjectTagInfoEXT': {'add_txt': 'add_VkDebugUtilsObjectTagInfoEXT_to_packet(pHeader, (VkDebugUtilsObjectTagInfoEXT**)&(pPacket->pTagInfo), pTagInfo)',
                                                 'finalize_txt': ''},
                           'VkDebugUtilsMessengerCallbackDataEXT': {'add_txt': 'add_VkDebugUtilsMessengerCallbackDataEXT_to_packet(pHeader, (VkDebugUtilsMessengerCallbackDataEXT**)&(pPacket->pCallbackData), pCallbackData)',
                                                 'finalize_txt': ''},
                           ...
                           'pName': {'add_txt': 'vktrace_add_buffer_to_trace_packet(pHeader, (void**)&(pPacket->pName), ((pName != NULL) ? strlen(pName) + 1 : 0), pName)',
                                     'finalize_txt': 'default'},
                           'pMarkerInfo': {'add_txt': 'vktrace_add_buffer_to_trace_packet(pHeader, (void**)&(pPacket->pMarkerInfo), sizeof(VkDebugMarkerMarkerInfoEXT), pMarkerInfo);\n'
                                                      '    if (pMarkerInfo)\n'
    ...
    def GenerateTrimStateTrackingInstructions(self, proto):
        ...
        if 'vkGetDeviceQueue' == proto.name:
            ...
            trim_instructions.append("        if(pCreateInfo->pNext != NULL) {")
            trim_instructions.append("            VkSemaphoreTypeCreateInfo *semaphoreTypeCreateInfo = (VkSemaphoreTypeCreateInfo*)find_ext_struct((const vulkan_struct_header*)pCreateInfo->pNext, VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO);")
            trim_instructions.append("            if(semaphoreTypeCreateInfo != NULL) {")
            trim_instructions.append("                info.ObjectInfo.Semaphore.semaphoreType = semaphoreTypeCreateInfo->semaphoreType;")
            trim_instructions.append("            }")
            trim_instructions.append("        }")
            trim_instructions.append("        else {")
            trim_instructions.append("            info.ObjectInfo.Semaphore.semaphoreType = -1;")
            trim_instructions.append("        }")
            trim_instructions.append("        if (pAllocator != NULL) {")
            ...
            trim_instructions.append('            vktrace_delete_trace_packet(&pHeader);')
            trim_instructions.append('        }')
        elif 'vkCmdEndRenderPass' in proto.name:
            ...
            trim_instructions.append("            pInfo->ObjectInfo.Image.needsStagingBuffer = trim::IsImageMemoryDeviceOnly(image);")
            trim_instructions.append("        }")
            trim_instructions.append('        if (g_trimIsInTrim) {')
            trim_instructions.append('            trim::mark_Image_reference(image);')
            trim_instructions.append('            trim::write_packet(pHeader);')
            ...
            trim_instructions.append('        if (g_trimIsInTrim) {')
            trim_instructions.append("            trim::remove_PipelineCache_object_later(pipelineCache);")
            ...
            trim_instructions.append("        trim::clear_CommandBuffer_calls_by_begin_renderpass(renderPass);")
            trim_instructions.append('        if (g_trimIsInTrim) {')
            trim_instructions.append('            trim::write_packet(pHeader);')
            trim_instructions.append('        } else {')
            trim_instructions.append('            vktrace_delete_trace_packet(&pHeader);')
            ...
            trim_instructions.append("        trim::clear_CommandBuffer_calls_by_begin_framebuffer(framebuffer);")
            trim_instructions.append('        if (g_trimIsInTrim) {')
            ...
            if proto.name.startswith('vkCmd'):
                trim_instructions.append("        trim::add_CommandBuffer_call(commandBuffer, trim::copy_packet(pHeader));")
                trim_instructions.append('        if (g_trimIsInTrim) {')
                trim_instructions.append('            trim::write_packet(pHeader);')
                trim_instructions.append('        } else {')
    ...
    def GenerateParserGenSource(self):
        ...
        for api in self.cmdMembers:
            ...
            if cmdname != 'GetInstanceProcAddr' and cmdname != 'GetDeviceProcAddr':
                ...
                if cmdname == 'CreateDescriptorSetLayout':
                    ...
                    dump_gen_source += '                if (pLocalCIs[i].pViewportState != NULL) {\n'
                    ...
                    dump_gen_source += '                }\n'
                    dump_gen_source += '                if (pLocalCIs[i].pMultisampleState != NULL) {\n'
        ...
        if VK_ANDROID_frame_boundary:
            dump_gen_source += '#if VK_ANDROID_frame_boundary\n'
            dump_gen_source += '        case VKTRACE_TPI_VK_vkFrameBoundaryANDROID: { \n'
            dump_gen_source += '            packet_vkFrameBoundaryANDROID* pPacket = (packet_vkFrameBoundaryANDROID*)(packet->pBody);\n'
            dump_gen_source += '            ApiDumpInstance& dump_inst = ApiDumpInstance::current();\n'
            dump_gen_source += '            const ApiDumpSettings& settings(dump_inst.settings());\n'
            dump_gen_source += '            dump_inst.setThreadID(packet->thread_id);\n'
            dump_gen_source += '            if (!settings.isFrameInRange(dump_inst.frameCount())) {\n'
            ...
            dump_gen_source += '            case ApiDumpFormat::Text:\n'
            dump_gen_source += '                const ApiDumpSettings& settings(dump_inst.settings());\n'
            dump_gen_source += '                if (settings.showThreadAndFrame()) {\n'
            dump_gen_source += '                    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount();\n'
            dump_gen_source += '                }\n'
            dump_gen_source += '                if (settings.showTimestamp() || settings.showThreadAndFrame()) {\n'
            dump_gen_source += '                    settings.stream() << \":\\n\";\n'
            dump_gen_source += '                }\n'
            dump_gen_source += '                settings.stream() << "vkFrameBoundaryANDROID(device, semaphore, image) returns VkResult";\n'
            dump_gen_source += '                settings.shouldFlush() ? settings.stream() << std::flush : settings.stream();\n'
            dump_gen_source += '                settings.stream() << \" \";\n'
            dump_gen_source += '                dump_text_VkResult(pPacket->result, settings, 0);\n'
            dump_gen_source += '                settings.stream() << \":\\n\";\n'
            dump_gen_source += '                if(settings.showParams())\n'
            dump_gen_source += '                {\n'
            dump_gen_source += '                    dump_text_value<const VkDevice>(pPacket->device, settings, "VkDevice", "device", 1, dump_text_VkDevice); // MET\n'
            dump_gen_source += '                    dump_text_value<const VkSemaphore>(pPacket->semaphore, settings, "VkSemaphore", "semaphore", 1, dump_text_VkSemaphore); // MET\n'
            dump_gen_source += '                    dump_text_value<const VkImage>(pPacket->image, settings, "VkImage", "image", 1, dump_text_VkImage); // MET\n'
            dump_gen_source += '                }\n'
            dump_gen_source += '                settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << \"\\n\";\n'
            dump_gen_source += '                break;\n'
            dump_gen_source += '            }\n'
            dump_gen_source += '            dump_inst.nextFrame();\n'
            dump_gen_source += '            break;\n'
            dump_gen_source += '        }\n'
            dump_gen_source += '#endif\n'
    ...
    def GenerateTraceVkSource(self):
        ...
        trace_vk_src += 'extern std::unordered_map<VkImage, VkImage> g_YuvImage2RgbaImage;\n'
        trace_vk_src += 'extern std::unordered_map<VkImageView, VkImageView> g_YuvImageView2RgbaImageView;\n'
        trace_vk_src += 'extern std::unordered_map<VkDeviceMemory, VkDeviceMemory> g_YuvMemory2RgbaMemory;\n'
        trace_vk_src += 'extern VkSamplerYcbcrConversion g_SamplerYcbcrConversion;\n'
        if VK_ANDROID_frame_boundary == 1:
            trace_vk_src += 'extern std::unordered_map<VkDevice, std::list<VkQueue>> g_devicetoQueues;\n'
        trace_vk_src += 'extern std::unordered_map<VkQueue, VkDevice> g_queueToDevice;\n'
        trace_vk_src += '\n'
        trace_vk_src += '#ifdef WIN32\n'
        ...
        trace_vk_src += '#endif\n'
        trace_vk_src += '    if (gMessageStream) {\n'
        trace_vk_src += '        vktrace_trace_set_trace_file(vktrace_FileLike_create_msg(gMessageStream));\n'
        trace_vk_src += '    } else {\n'
        trace_vk_src += '#if defined(ANDROID)\n'
        trace_vk_src += '        const char * defaultTraceFileName = "/sdcard/app.capture.orig.vktrace";\n'
        trace_vk_src += '#else\n'
        trace_vk_src += '        const char * defaultTraceFileName = "./app.capture.orig.vktrace";\n'
        trace_vk_src += '#endif\n'
        trace_vk_src += '        gMessageStream = VKTRACE_NEW(MessageStream);\n'
        trace_vk_src += '        const char *traceFileName = vktrace_get_global_var("VKTRACE_TRACE_PATH_FILENAME");\n'
        trace_vk_src += '        if (traceFileName == NULL || strlen(traceFileName) < 7) {\n'
        trace_vk_src += '            traceFileName = defaultTraceFileName;\n'
        trace_vk_src += '        }\n'
        trace_vk_src += '        vktrace_LogAlways("vktrace_lib save local file path: %s ", traceFileName);\n'
        trace_vk_src += '        gMessageStream->mTraceFile = fopen(traceFileName, "w+b");\n'
        trace_vk_src += '        if (gMessageStream->mTraceFile != nullptr) {\n'
        trace_vk_src += '            vktrace_trace_set_trace_file(vktrace_FileLike_create_file(gMessageStream->mTraceFile));\n'
        trace_vk_src += '        } else {\n'
        trace_vk_src += '            vktrace_LogError("vktrace_lib open local file path: %s failed!", traceFileName);\n'
        trace_vk_src += '        }\n'
        trace_vk_src += '    }\n'
        ...
        for proto in self.cmdMembers:
            ...
            if proto.name in manually_written_hooked_funcs:
                ...
                elif proto.name == 'vkCmdInsertDebugUtilsLabelEXT':
                    trace_vk_src += '    CREATE_TRACE_PACKET(vkCmdInsertDebugUtilsLabelEXT, get_struct_chain_size((void*)pLabelInfo));\n'
                elif proto.name == 'vkQueueInsertDebugUtilsLabelEXT':
                    trace_vk_src += '    CREATE_TRACE_PACKET(vkQueueInsertDebugUtilsLabelEXT, get_struct_chain_size((void*)pLabelInfo));\n'
                elif proto.name == 'vkCmdBeginDebugUtilsLabelEXT':
                    trace_vk_src += '    CREATE_TRACE_PACKET(vkCmdBeginDebugUtilsLabelEXT, get_struct_chain_size((void*)pLabelInfo));\n'
                elif proto.name == 'vkSubmitDebugUtilsMessageEXT':
                    trace_vk_src += '    CREATE_TRACE_PACKET(vkSubmitDebugUtilsMessageEXT, get_struct_chain_size((void*)pCallbackData));\n'
                else:
                ...
                if proto.name == 'vkGetBufferDeviceAddress':
                    ...
                    trace_vk_src += '    %s%s.%s;\n' % (return_txt, table_txt, c_call)
                if VK_ANDROID_frame_boundary == 1 and proto.name == 'vkGetDeviceQueue':
                    trace_vk_src += '    g_devicetoQueues[device].push_back(*pQueue);\n'
                ...
                if proto.name == 'vkCreateImage':
                    ...
                    trace_vk_src += '                g_cmdBufferToBuffers[pCommandBuffers[i]].clear();\n'
                    ...
                    trace_vk_src += '                g_cmdBufferToImages[pCommandBuffers[i]].clear();\n'
                    ...
                    trace_vk_src += '                g_cmdbufferToDescriptorSets[pCommandBuffers[i]].clear();\n'
                    ...
                    trace_vk_src += '                g_cmdBufferToAS[pCommandBuffers[i]].clear();\n'
                    ...
                    trace_vk_src += '    }\n'
                    trace_vk_src += '#endif\n'
                    trace_vk_src += 'auto it = g_YuvImageView2RgbaImageView.find(imageView);\n'
                    trace_vk_src += 'if (it != g_YuvImageView2RgbaImageView.end()) {\n'
                    trace_vk_src += '    imageView = it->second;\n'
                    trace_vk_src += '    mdd(device)->devTable.DestroyImageView(device, imageView, pAllocator);\n'
                    trace_vk_src += '    g_YuvImageView2RgbaImageView.erase(it);\n'
                    trace_vk_src += '}\n'
                elif proto.name == 'vkDestroyImage':
                    trace_vk_src += '    auto it = g_YuvImage2RgbaImage.find(image);\n'
                    trace_vk_src += '    if (it != g_YuvImage2RgbaImage.end()) {\n'
                    trace_vk_src += '        image = it->second;\n'
                    trace_vk_src += '        mdd(device)->devTable.DestroyImage(device, image, pAllocator);\n'
                    trace_vk_src += '        g_YuvImage2RgbaImage.erase(it);\n'
                    trace_vk_src += '    }\n'
                elif proto.name == 'vkCreateSamplerYcbcrConversion':
                    trace_vk_src += '    if (g_SamplerYcbcrConversion == VK_NULL_HANDLE) {\n'
                    trace_vk_src += '        g_SamplerYcbcrConversion = *pYcbcrConversion;\n'
                    trace_vk_src += '    } else {\n'
                    trace_vk_src += '        vktrace_LogAlways("WARN: There are multiple SamplerYcbcrConversion.");\n'
                    trace_vk_src += '    }\n'
                elif proto.name == 'vkCreateSampler':
                    trace_vk_src += '    VkSamplerYcbcrConversionInfo *pSamplerYcbcrConversionInfo = (VkSamplerYcbcrConversionInfo*)find_ext_struct((const vulkan_struct_header*)pCreateInfo->pNext, VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO);\n'
                    trace_vk_src += '    if (pSamplerYcbcrConversionInfo != nullptr) {\n'
                    trace_vk_src += '        //Need to further judge the pNext;\n'
                    trace_vk_src += '        const_cast<VkSamplerCreateInfo*>(pCreateInfo)->pNext = nullptr;\n'
                    trace_vk_src += '    }\n'
                    ...
                    trace_vk_src += '    }\n'
                    trace_vk_src += '#endif\n'
                elif proto.name in [ 'vkGetBufferMemoryRequirements' ]:
                    trace_vk_src += '    if (getReBindMemoryAndAlignedSizeEnable() & 0x01) {\n'
                    trace_vk_src += '        pMemoryRequirements->size = pageguardGetAdjustedSize(pMemoryRequirements->size);\n'
                    trace_vk_src += '        pMemoryRequirements->alignment = pageguardGetAdjustedSize(pMemoryRequirements->alignment);\n'
                    trace_vk_src += '    }\n'
                elif proto.name in [ 'vkGetBufferMemoryRequirements2', 'vkGetBufferMemoryRequirements2KHR' ]:
                    trace_vk_src += '    if (getReBindMemoryAndAlignedSizeEnable() & 0x01) {\n'
                    trace_vk_src += '        pMemoryRequirements->memoryRequirements.size = pageguardGetAdjustedSize(pMemoryRequirements->memoryRequirements.size);\n'
                    trace_vk_src += '        pMemoryRequirements->memoryRequirements.alignment = pageguardGetAdjustedSize(pMemoryRequirements->memoryRequirements.alignment);\n'
                    trace_vk_src += '    }\n'
                elif proto.name in [ 'vkGetImageMemoryRequirements2', 'vkGetImageMemoryRequirements2KHR' ]:
                    trace_vk_src += '    if (getReBindMemoryAndAlignedSizeEnable() & 0x01) {\n'
                    trace_vk_src += '        pMemoryRequirements->memoryRequirements.size = pageguardGetAdjustedSize(pMemoryRequirements->memoryRequirements.size);\n'
                    trace_vk_src += '        pMemoryRequirements->memoryRequirements.alignment = pageguardGetAdjustedSize(pMemoryRequirements->memoryRequirements.alignment);\n'
                    trace_vk_src += '    }\n'
                    trace_vk_src += '    VkMemoryRequirements2 yuvMemoryRequirements2 = {};\n'
                    trace_vk_src += '    auto it = g_YuvImage2RgbaImage.find(pInfo->image);\n'
                    trace_vk_src += '    if (it != g_YuvImage2RgbaImage.end()) {\n'
                    trace_vk_src += '        yuvMemoryRequirements2 = *pMemoryRequirements;\n'
                    trace_vk_src += '        const_cast<VkImageMemoryRequirementsInfo2*>(pInfo)->image = it->second;\n'
                    trace_vk_src += '        mdd(device)->devTable.GetImageMemoryRequirements2(device, pInfo, pMemoryRequirements);\n'
                    trace_vk_src += '    }\n'
                elif proto.name in [ 'vkGetImageMemoryRequirements' ]:
                    trace_vk_src += '    if (getReBindMemoryAndAlignedSizeEnable() & 0x01) {\n'
                    trace_vk_src += '        pMemoryRequirements->size = pageguardGetAdjustedSize(pMemoryRequirements->size);\n'
                    trace_vk_src += '        pMemoryRequirements->alignment = pageguardGetAdjustedSize(pMemoryRequirements->alignment);\n'
                    trace_vk_src += '    }\n'
                    trace_vk_src += '    VkMemoryRequirements yuvMemoryRequirements = {};\n'
                    trace_vk_src += '    auto it = g_YuvImage2RgbaImage.find(image);\n'
                    trace_vk_src += '    if (it != g_YuvImage2RgbaImage.end()) {\n'
                    trace_vk_src += '        yuvMemoryRequirements = *pMemoryRequirements;\n'
                    trace_vk_src += '        image = it->second;\n'
                    trace_vk_src += '        mdd(device)->devTable.GetImageMemoryRequirements(device, image, pMemoryRequirements);\n'
                    trace_vk_src += '    }\n'
                ...
                if proto.name == 'vkGetPhysicalDeviceSurfaceFormats2KHR':
                    ...
                    for pp_dict in ptr_packet_update_list: # buff_ptr_indices:
                        ...
                        if ('(pPacket->pSurfaceInfo)' in pp_dict['add_txt'] and ('2KHR' in pp_dict['add_txt'])):
                            trace_vk_src += '    vktrace_add_pnext_structs_to_trace_packet(pHeader, (void *)pPacket->pSurfaceInfo, (void *)pSurfaceInfo);\n'
                        if ('(pPacket->pSurfaceCapabilities)' in pp_dict['add_txt'] and ('2KHR' in pp_dict['add_txt'])):
                            trace_vk_src += '    vktrace_add_pnext_structs_to_trace_packet(pHeader, (void *)pPacket->pSurfaceCapabilities, (void *)pSurfaceCapabilities);\n'
                ...
                elif proto.name == 'vkGetImageMemoryRequirements' :
                    trace_vk_src += '    if (yuvMemoryRequirements.size != 0) {\n'
                    trace_vk_src += '        *pMemoryRequirements = yuvMemoryRequirements;\n'
                    trace_vk_src += '    }\n'
                elif proto.name in [ 'vkGetImageMemoryRequirements2', 'vkGetImageMemoryRequirements2KHR' ]:
                    trace_vk_src += '    if (yuvMemoryRequirements2.memoryRequirements.size != 0) {\n'
                    trace_vk_src += '        *pMemoryRequirements = yuvMemoryRequirements2;\n'
                    trace_vk_src += '    }\n'
                trace_vk_src += '    if (!g_trimEnabled) {\n'
                ...
                if trim_instructions is not None:
                    ...
                    if proto.name == 'vkGetAccelerationStructureDeviceAddressKHR':
                        ...
                        trace_vk_src += '            }\n'
                    if proto.name == 'vkGetRayTracingShaderGroupHandlesKHR':
                        trace_vk_src += '            trim::ObjectInfo* pRtpInfo = trim::get_Pipeline_objectInfo(pipeline);\n'
                        trace_vk_src += '            if (pRtpInfo != nullptr && pRtpInfo->ObjectInfo.Pipeline.rayTracingShaderGroupHandlesCount < INT8_MAX) {\n'
                        trace_vk_src += '                pRtpInfo->ObjectInfo.Pipeline.pGetRayTracingShaderGroupHandlesKHRPackets[pRtpInfo->ObjectInfo.Pipeline.rayTracingShaderGroupHandlesCount] = trim::copy_packet(pHeader);\n'
                        trace_vk_src += '                pRtpInfo->ObjectInfo.Pipeline.rayTracingShaderGroupHandlesCount++;\n'
                        trace_vk_src += '            }\n'
    ...
    def GenerateTraceVkPacketsHeader(self):
        ...
        create_rp2_interp = ['VkRenderPassCreateInfo2* pInfo = (VkRenderPassCreateInfo2*)pPacket->pCreateInfo;\n',
                            ...
                            '}\n',
                            'for (i=0; i<pInfo->subpassCount; i++) {\n',
                            '    for (uint32_t k=0; k<pInfo->pSubpasses[i].inputAttachmentCount; k++) {\n',
                            '        vkreplay_process_pnext_structs(pHeader, (void *)(&(pInfo->pSubpasses[i].pInputAttachments[k])));\n',
                            '    }\n',
                            '    for (uint32_t k=0; k<pInfo->pSubpasses[i].colorAttachmentCount; k++) {\n',
                            '        vkreplay_process_pnext_structs(pHeader, (void *)(&(pInfo->pSubpasses[i].pColorAttachments[k])));\n',
                            '    }\n',
                            '    vkreplay_process_pnext_structs(pHeader, (void *)pInfo->pSubpasses[i].pResolveAttachments);\n',
                            '    vkreplay_process_pnext_structs(pHeader, (void *)pInfo->pSubpasses[i].pDepthStencilAttachment);\n',
                            '}\n',
        ...
        create_gfx_pipe = ['uint32_t i;\n',
                           ...
                           'for (i=0; i<pPacket->createInfoCount; i++) {\n',
                            ...
                            '}\n',
                            '}\n']
        create_GetDeviceImageMemoryRequirements = [
                            'VkDeviceImageMemoryRequirements* pInfo = (VkDeviceImageMemoryRequirements*)pPacket->pInfo;\n',
                            'pInfo->pCreateInfo = (VkImageCreateInfo*) vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pInfo->pCreateInfo);\n',
                            'vkreplay_process_pnext_structs(pHeader, (void *)pInfo->pCreateInfo);\n',
                            ]
        ...
        custom_case_dict = { 'CreateRenderPass' : {'param': 'pCreateInfo', 'txt': create_rp_interp},
                             ...
                             'QueuePresentKHR' : {'param': 'pPresentInfo', 'txt': ['VkSwapchainKHR **ppSC = (VkSwapchainKHR **)& pPacket->pPresentInfo->pSwapchains;\n',
                                                                                   ...
                                                                                   '}']},
                             'WaitSemaphores' : {'param': 'pWaitInfo', 'txt': [ 'VkSemaphore **ppSem = (VkSemaphore **)& pPacket->pWaitInfo->pSemaphores;\n',
                                                                                   '*ppSem = (VkSemaphore*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)(pPacket->pWaitInfo->pSemaphores));\n',
                                                                                   'uint64_t **ppVal = (uint64_t **) &pPacket->pWaitInfo->pValues;\n',
                                                                                   '*ppVal = (uint64_t *) vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)(pPacket->pWaitInfo->pValues));\n',
                                                                                   ]},
                             'WaitSemaphoresKHR' : {'param': 'pWaitInfo', 'txt': [ 'VkSemaphore **ppSem = (VkSemaphore **)& pPacket->pWaitInfo->pSemaphores;\n',
                                                                                   '*ppSem = (VkSemaphore*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)(pPacket->pWaitInfo->pSemaphores));\n',
                                                                                   'uint64_t **ppVal = (uint64_t **) &pPacket->pWaitInfo->pValues;\n',
                                                                                   '*ppVal = (uint64_t *) vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)(pPacket->pWaitInfo->pValues));\n',
                                                                                   ]},
                             ...
                             'GetDeviceImageMemoryRequirementsKHR' : {'param': 'pInfo', 'txt' : create_GetDeviceImageMemoryRequirements},
                             'GetDeviceImageMemoryRequirements' : {'param': 'pInfo', 'txt' : create_GetDeviceImageMemoryRequirements},
        }
        if_body = []
        ...
        trace_pkt_hdr += '}\n\n'
        if VK_ANDROID_frame_boundary:
            trace_pkt_hdr += 'typedef struct packet_vkFrameBoundaryANDROID {\n'
            trace_pkt_hdr += '    vktrace_trace_packet_header* header;\n'
            trace_pkt_hdr += '    VkDevice device;\n'
            trace_pkt_hdr += '    VkSemaphore semaphore;\n'
            trace_pkt_hdr += '    VkImage image;\n'
            trace_pkt_hdr += '    VkResult result;\n'
            trace_pkt_hdr += '} packet_vkFrameBoundaryANDROID;\n\n'
            trace_pkt_hdr += 'static packet_vkFrameBoundaryANDROID* interpret_body_as_vkFrameBoundaryANDROID(vktrace_trace_packet_header* pHeader) {\n'
            trace_pkt_hdr += '    packet_vkFrameBoundaryANDROID* pPacket = (packet_vkFrameBoundaryANDROID*)pHeader->pBody;\n'
            trace_pkt_hdr += '    pPacket->header = pHeader;\n'
            trace_pkt_hdr += '    return pPacket;\n'
            trace_pkt_hdr += '}\n\n'
        cmd_info_dict = dict(self.cmd_info_data)
        ...
        for proto in self.cmdMembers:
            ...
            if novk_name not in api_exclusions:
                ...
                if 'UnmapMemory' in proto.name or 'CreateRayTracingPipelines' in proto.name:
                    ...
                    count_4byte += 1
                if 'FlushMappedMemoryRangesRemapAsInstance' in proto.name:
                    trace_pkt_hdr += '    void** ppDataAsOffset;\n'
                    count_4byte += 1
                    trace_pkt_hdr += '    void** ppDataSGHandleOffset;\n'
                    count_4byte += 1
                    trace_pkt_hdr += '    void** ppDataBufferOffset;\n'
                    count_4byte += 1
                if 'UnmapMemoryRemapAsInstance' in proto.name:
                    trace_pkt_hdr += '    void* pDataAsOffset;\n'
                    count_4byte += 1
                    trace_pkt_hdr += '    void* pDataSGHandleOffset;\n'
                    count_4byte += 1
                    trace_pkt_hdr += '    void* pDataBufferOffset;\n'
                    count_4byte += 1
                resulttype = cmdinfo.elem.find('proto/type')
                if resulttype is not None and resulttype.text != 'void':
                ...
                for p in proto.members:
                    if p.name != '' and p.ispointer:
                        ...
                        elif 'DependencyInfo' in p.type and "pDependencyInfo" == p.name:
                            trace_pkt_hdr += '    pPacket->%s = interpret_VkDependencyInfo(pHeader, (intptr_t)pPacket->%s);\n' % (p.name, p.name)
                        ...
                        elif 'DebugMarkerObjectTagInfoEXT' in p.type:
                            trace_pkt_hdr += '    pPacket->%s = interpret_VkDebugMarkerObjectTagInfoEXT(pHeader, (intptr_t)pPacket->%s);\n' % (p.name, p.name)
                        elif 'DebugUtilsObjectNameInfoEXT' in p.type:
                            trace_pkt_hdr += '    pPacket->%s = interpret_VkDebugUtilsObjectNameInfoEXT(pHeader, (intptr_t)pPacket->%s);\n' % (p.name, p.name)
                        elif 'DebugUtilsObjectTagInfoEXT' in p.type:
                            trace_pkt_hdr += '    pPacket->%s = interpret_VkDebugUtilsObjectTagInfoEXT(pHeader, (intptr_t)pPacket->%s);\n' % (p.name, p.name)
                        elif 'DebugUtilsMessengerCallbackDataEXT' in p.type:
                            trace_pkt_hdr += '    pPacket->%s = interpret_VkDebugUtilsMessengerCallbackDataEXT(pHeader, (intptr_t)pPacket->%s);\n' % (p.name, p.name)
                        else:
                        ...
                        if ((p.name in ['pCreateInfo', 'pBeginInfo', 'pBindInfos','pAllocateInfo','pReserveSpaceInfo','pLimits','pExternalBufferInfo','pExternalBufferProperties',
                            ...
                            elif "vkCmdDebugMarkerBeginEXT" == proto.name or "vkCmdDebugMarkerInsertEXT" == proto.name:
                ...
                if 'UnmapMemory' in proto.name or 'CreateRayTracingPipelines' in proto.name:
                    if 'UnmapMemoryRemapAsInstanceSGHandle' in proto.name:
                        trace_pkt_hdr += '    pPacket->pData = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->pData);\n'
                        trace_pkt_hdr += '    pPacket->pDataAsOffset = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->pDataAsOffset);\n'
                        trace_pkt_hdr += '    pPacket->pDataSGHandleOffset = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->pDataSGHandleOffset);\n'
                        trace_pkt_hdr += '    pPacket->pDataBufferOffset = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->pDataBufferOffset);\n'
                    else:
                        trace_pkt_hdr += '    pPacket->pData = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->pData);\n'
                if 'FlushMappedMemoryRanges' in proto.name or 'InvalidateMappedMemoryRanges' in proto.name:
                    if 'FlushMappedMemoryRangesRemapAsInstanceSGHandle' in proto.name:
                        trace_pkt_hdr += '    pPacket->ppData = (void**)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppData);\n'
                        trace_pkt_hdr += '    pPacket->ppDataAsOffset = (void**)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataAsOffset);\n'
                        trace_pkt_hdr += '    pPacket->ppDataSGHandleOffset = (void**)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataSGHandleOffset);\n'
                        trace_pkt_hdr += '    pPacket->ppDataBufferOffset = (void**)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataBufferOffset);\n'
                        ...
                        trace_pkt_hdr += '            pPacket->ppDataAsOffset[i] = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataAsOffset[i]);\n'
                        trace_pkt_hdr += '            pPacket->ppDataSGHandleOffset[i] = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataSGHandleOffset[i]);\n'
                        trace_pkt_hdr += '            pPacket->ppDataBufferOffset[i] = (void*)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppDataBufferOffset[i]);\n'
                        trace_pkt_hdr += '        }\n'
                        trace_pkt_hdr += '    }\n'
                    else:
                        trace_pkt_hdr += '    pPacket->ppData = (void**)vktrace_trace_packet_interpret_buffer_pointer(pHeader, (intptr_t)pPacket->ppData);\n'
