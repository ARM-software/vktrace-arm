...
( cd generated/include; ${PYTHON_EXECUTABLE} ${LVL_SCRIPTS}/external_revision_generator.py --git_dir ../../third_party/Vulkan-ValidationLayers/build-android/third_party/shaderc/third_party/spirv-tools -s SPIRV_TOOLS_COMMIT_ID -o spirv_tools_commit_id.h )
